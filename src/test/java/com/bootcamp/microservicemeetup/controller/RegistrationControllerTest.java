...
import com.bootcamp.microservicemeetup.controller.resources.RegistrationController;
import com.bootcamp.microservicemeetup.exception.BusinessException;
import com.bootcamp.microservicemeetup.controller.dto.RegistrationDTO;
...
public class RegistrationControllerTest {
    ...
    public void createRegistrationTest() throws Exception {
        ...
        Registration savedRegistration = Registration.builder().id(101).name("Duda").dateOfRegistration("10/10/2022").registration("001").build();
        ...
        //requisicao pro controller, o DTO sera transpassado entre os metodos
        String json  = new ObjectMapper().writeValueAsString(registrationDTOBuilder);


        //simula uma requsicao
    ...
    public void deleteRegistration() throws Exception {
        ...
        BDDMockito.given(registrationService.getRegistrationById(anyInt())).willReturn(Optional.of(Registration.builder().id(11).build()));
    ...
    @Test
    @DisplayName("Should return resource not found when no registration is not found to delete")
    ...
    @Test
    @DisplayName("Should return 404 when try to update an registration nonexistent")
    ...
    private RegistrationDTO createNewRegistration(){
        ...
        return RegistrationDTO.builder().id(10).name("Duda").dateOfRegistration("10/10/2022").registration("001").build();
    }
}
